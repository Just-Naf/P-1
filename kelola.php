    ...
    <nav class="navbar bg-body-tertiary mb-3">
      ...
      <div class="container-fluid">
        ...
        <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <input required type="text" name="nisn" class="form-control" id="nisn" placeholder="123132" value="<?php echo $nisn; ?>">
              </div>
            </div>
            <div class="mb-3 row">
              <label for="nama" class="col-sm-2 col-form-label">Nama Siswa</label>
              <div class="col-sm-10">
                <input required type="text"name="nama_siswa" class="form-control" id="nama" placeholder="Ahmad Suparjo" value="<?php echo $nama_siswa; ?>">
              </div>
            </div>
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <select required id="jkel" name="jenis_kelamin" class="form-select">
                  ...
                  <option <?php if($jenis_kelamin == 'Gundam'){echo "selected";} ?> value="Gundam">Gundam</option>
                </select>
              </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
              <label for="quotes" class="col-sm-2 col-form-label">Tuliskan Quotes Mu</label>
              <div class="col-sm-10">
                <textarea required class="form-control" name="quotes" id="quotes" rows="3"><?php echo $quotes; ?></textarea>
              </div>
            </div>
